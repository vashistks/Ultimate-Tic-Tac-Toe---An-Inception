...
function createPlayer(num) {
  ...
  if(num == '1'){
    ...
    playerJsonObj.players.playerslist.player1.players_name = document.getElementById("playername1").value;
    playerJsonObj.players.playerslist.player1.players_marker = document.getElementById("playermarker1").value;
    ...
    var players_name;
    var players_marker;
    player2['players_name'] = document.getElementById("playername2").value;
    player2['players_marker'] = document.getElementById("playermarker2").value;
    var obj = playerJsonObj.players.playerslist;
    obj['player2'] = player2;
  //  playerJsonObj[players][playerslist]['player2'] = player2;
    //playerJsonObj.players.playerslist.player2.players_marker
...
function getCurrentmarker(currentplayer){
  ...
  if(currentplayer == '1'){
  cur = playerJsonObj.playerinfo.player1.player1_marker;
  console.log('currentmarker',cur);
  }
  else if(currentplayer == '2'){
  cur = playerJsonObj.playerinfo.player2.player2_marker;
  console.log('currentmarker',cur);
  }
  return cur;
}
...
function setSelection(selectionval,divboard){
  ...
  console.log('current outer: ',playerJsonObj.currentouter);
  ...
  // var celldata = divElement.getElementsByTagName("td")[selectionval];
  ...
  if(arr == ""){
    ...
    for(var i in arr){
      if(inc.toString() == arr[i]){
        console.log("entered unblovk");
        enableAllUnblockedTables();
      }
      else{
        disableAllTables();
        console.log('else empty check');
        $(outerboard).each(function()
        {
          this.style.pointerEvents = 'auto';
        });
...
function enableAllUnblockedTables(){
  enableAllTables();
  var arr = playerJsonObj.disabledblocks;
  for(var i in arr){
    var num = arr[i];
